...
COPY account_journal_bank_exclusivity /mnt/extra-addons/account_journal_bank_exclusivity
COPY account_move_draft_payment_block  /mnt/extra-addons/account_move_draft_payment_block
