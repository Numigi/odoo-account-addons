...
def check_bank_is_selected_on_bank_accounts(payments: Payment, context: dict) -> None:
    accounts_with_no_bank = payments.mapped("partner_bank_account_id").filtered(
...
def check_transit_number_is_set_on_bank_accounts(payments: Payment, context: dict) -> None:
    accounts_with_no_transit = payments.mapped("partner_bank_account_id").filtered(
...
def check_institution_number_is_set_on_banks(payments: Payment, context: dict) -> None:
    banks_with_no_institution = payments.mapped("partner_bank_account_id.bank_id").filtered(
...
def check_account_number_between_7_and_12_digits(payments: Payment, context: dict) -> None:
    accounts_with_wrong_chars = payments.mapped("partner_bank_account_id").filtered(
    ...
    accounts_with_more_12_digits = payments.mapped("partner_bank_account_id").filtered(
    ...
    accounts_with_less_7_digits = payments.mapped("partner_bank_account_id").filtered(
